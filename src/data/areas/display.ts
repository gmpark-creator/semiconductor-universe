...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    keySpecs: [
      ...
      "4세대 'Penta Tandem' 5층(청3·녹2) 적층으로 효율·수명 향상",
      "잉크젯 QD 공정으로 고해상·고주사율(360Hz) 패널화",
    ],
    examples: ["삼성 OLED TV(QD-OLED)", "고급 게이밍 모니터(QD-OLED)", "27인치 4K QD-OLED 모니터 패널", "대형 프리미엄 TV 패널"],
    trend: "2025~2026년 삼성디스플레이는 4세대 QD-OLED를 5층 적층 'Penta Tandem'으로 공식화하고, 신규 EL 소재로 효율을 30% 이상 개선해 전력 증가 없이 휘도·수명을 높였다(밝기 1,300니트급). 피코 잉크젯 QD 공정으로 같은 면적에 화소를 더 넣어 27인치 4K·360Hz 고사양 모니터 패널 양산을 확대 중이다.",
  },
  {
...
export const COMPANIES: Company[] = [
  ...
  C("solus", "솔루스첨단소재", "OLED 발광/공통층 소재 (+동박 겸업)", "Material", "전북 익산 함열", 36.0500, 126.9620, 420,
    ...
    "두산서 인적분할·스카이레이크 보유. OLED 소재+전지박 양대 축",
    "전북 익산을 거점으로 한 첨단소재 기업으로 2019년 두산 전자BG에서 인적분할(옛 두산솔루스)되어 출범했고 현재 사모펀드 스카이레이크가 경영권 지분을 보유한다. OLED 사업부는 유기발광·공통층 재료와 QD(퀀텀닷) 소재를 공급하며, 별도로 유럽·캐나다 거점의 전지박(배터리 동박) 사업을 겸한다. 2025년 전사 매출은 약 6,164억 원으로 사상 최대였고 이 중 OLED 사업부 매출은 약 1,262억 원으로, 2026년 OLED 약 1,390억 원 목표를 제시했다. (전사 매출과 사업부 매출 혼동 주의)",
    [{ field: "OLED 유기재료·QD 소재", pct: "디스플레이 주력" }, { field: "전지박(배터리 동박)", pct: "전사 매출 대부분" }]),
  C("dongwoo", "동우화인켐", "편광판·포토레지스트·컬러필터 소재", "Material", "전북 익산 신흥동", 35.9300, 126.9890, 700,
    "2024 매출", "≈1.96조 원",
    "日 스미토모화학 100% 자회사, 편광판·디스플레이/반도체 케미컬 대형 소재사",
    "전북 익산에 본사를 둔 일본 스미토모화학의 100% 자회사로, 1991년 설립 후 LCD/OLED용 편광판, 디스플레이·반도체용 포토레지스트, 고순도 기능성 케미컬, 컬러필터·터치센서 소재를 생산한다. 익산 본사 외 평택공장을 운영하며 삼성디스플레이·삼성전자·SK하이닉스 등에 납품한다. 2024년 매출은 약 1.96조 원 규모로 본 영역 소재사 중 최대급이며, 익산 산단에 수천억 원대 추가 투자로 OLED용 편광필름·반도체 소재 증설을 추진 중이다.",
  ...
  C("dowinsys", "도우인시스", "폴더블 UTG(초박막강화유리) 소재", "Material", "충북 청주 옥산", 36.6818, 127.3554, 360,
    ...
    "세계 최초 폴더블 UTG 양산, 삼성디스플레이 인수 자회사",
    "충북 청주 흥덕구 옥산면에 본사·공장을 둔 초박막강화유리(UTG) 전문기업으로, 세계 최초로 폴더블 스마트폰용 30~100μm 두께 UTG를 양산했다. 삼성디스플레이(SDC)가 인수한 협력사로 삼성전자 폴더블폰용 UTG를 사실상 독점 공급하며, 청주 옥산공장과 베트남 송콩2 공장을 운영한다. 2026년 코스닥에 상장했고, 애플 폴더블 진입 기대감으로 주목받는다.",
...
const DETAILS: Record<string, CompanyDetail> = {
  ...
  solus: {
    ...
    shareholders: [sh("스카이레이크(SPC 경유)", "≈53%"), sh("기타·소액주주", "≈47%")],
    financials: [
  ...
  dowinsys: {
    listing: "KOSDAQ (2026 상장)",
    marketCap: "상장 후 시총(시점별 변동)",
    shareholders: [sh("삼성디스플레이", "≈27.7% (최대주주)"), sh("뉴파워프라즈마·기타·소액", "나머지")],
    financials: [
